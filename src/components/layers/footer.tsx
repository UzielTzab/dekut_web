        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="text-lg font-bold tracking-wider">Dekut Games</span>
            </div>
            <div className="text-sm text-gray-400">© {new Date().getFullYear()} Dekut Games. All rights reserved.</div>
